  ...
  return (
    <>
      ...
      {presupuestos.length === 0 ? (
        <div className="text-center mt-10 p-10 bg-white shadow-lg border rounded-lg">
          <p className="text-xl text-gray-600">No hay presupuestos creados aún</p>
          <p className="text-gray-500 mt-2">¡Crea tu primer presupuesto para empezar a gestionar tus finanzas!</p>
        </div>
      ) : (
        <div>
            ...
            {presupuestos.map((budget) => (
              <li key={budget.id} className="flex justify-between gap-x-6 p-5">
                ...
                <div className="flex shrink-0 items-center gap-x-6">
                  <BudgetMenu budgetId={String(budget.id)} />
                </div>
              </li>
            ))}
          </ul>
